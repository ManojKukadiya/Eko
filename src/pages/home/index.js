        ...
        return (
            ...
            <section className="p-0">
              <div className="container-fluid pl-0">
                <Row>
                  <Col md={6} className="col-sm-5 parallaxie custom-py-3 rounded" style={{ backgroundImage: `url(${require(`../../assets/images/bg/03.jpg`)}` , backgroundPosition: 'center center', backgroundSize: 'cover', backgroundRepeat: 'no-repeat' }}  />
